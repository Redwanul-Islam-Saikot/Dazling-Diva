            ...
            <div className="space-y-1 pt-2">
              ...
              {homeOpen && (
                <div className="ml-6 mt-1 space-y-1 border-l border-slate-800 pl-9">
                  ...
                  <button onClick={() => router.push("/admin/promo-cards")} className={`block w-full py-1.5 text-left text-xs transition-all ${isActive("/admin/promo-cards") ? "font-bold text-amber-400" : "text-slate-400 hover:text-amber-400"}`}>PromoGrid</button>
